...
export default function LoginButton({ onProfileClick }) {
    ...
    return (
        <button
            onClick={login}
            className="group flex items-center gap-3 px-5 py-2.5 bg-gradient-to-r from-red-600 to-red-500 hover:from-red-500 hover:to-red-400 rounded-lg text-white text-sm font-bold uppercase tracking-wider shadow-[0_0_20px_rgba(239,68,68,0.4)] hover:shadow-[0_0_30px_rgba(239,68,68,0.6)] transition-all duration-300 border border-red-400/30 min-w-[210px] justify-center"
            style={{ fontFamily: 'Orbitron, sans-serif' }}
        >
